...
var _normalizeProjectName = _interopRequireDefault(
  require('./normalizeProjectName')
);
...
function makeSettingsPatch(name, androidConfig, projectConfig) {
  ...
  const projectDir = (0, _slash().default)(
    _path().default.relative(
      _path().default.dirname(projectConfig.settingsGradlePath),
