...
var _addToHeaderSearchPaths = _interopRequireDefault(
  require('./addToHeaderSearchPaths')
);
...
var _createGroupWithMessage = _interopRequireDefault(
  require('./createGroupWithMessage')
);

var _addFileToProject = _interopRequireDefault(require('./addFileToProject'));

var _addProjectToLibraries = _interopRequireDefault(
  require('./addProjectToLibraries')
);

var _addSharedLibraries = _interopRequireDefault(
  require('./addSharedLibraries')
);
...
function registerNativeModuleIOS(dependencyConfig, projectConfig) {
  ...
  const libraries = (0, _createGroupWithMessage.default)(
    project,
    projectConfig.libraryFolder
  );
  const file = (0, _addFileToProject.default)(
    project,
  ...
  if (!(0, _lodash().isEmpty)(headers)) {
    (0, _addToHeaderSearchPaths.default)(
      project,
