...
var _removeFromPbxItemContainerProxySection = _interopRequireDefault(
  require('./removeFromPbxItemContainerProxySection')
);

var _removeFromProjectReferences = _interopRequireDefault(
  require('./removeFromProjectReferences')
);

var _removeProductGroup = _interopRequireDefault(
  require('./removeProductGroup')
);
...
function removeProjectFromProject(project, filePath) {
  const file = project.removeFromPbxFileReferenceSection(
    new (_pbxFile()).default(filePath)
  );
