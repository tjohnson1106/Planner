...
class JsPackagerClient {
  constructor(url) {
    ...
    this.ws.on('message', (data, flags) => {
      const message = _messageSocket.default.parseMessage(data, flags.binary);
      ...
      if (message === undefined || message.id === undefined) {
        ...
        _logger.default.warn(
          `Response with non-existing message id: '${message.id}'`
        );
    ...
    return this.openPromise.then(
      () =>
        new Promise((resolve, reject) => {
          ...
          this.msgCallbacks.set(messageId, {
            resolve,
            reject
          });
          this.ws.send(
