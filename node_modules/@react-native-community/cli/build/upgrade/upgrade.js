...
function validateAndUpgrade(argv, ctx) {
  ...
  const packageJSON = JSON.parse(
    _fs().default.readFileSync(
      _path().default.resolve(projectDir, 'package.json'),
      'utf8'
    )
  );
  warn(
  ...
  _logger.default.info(
    `Upgrading project to react-native v${installed.version}\n` +
      ...
      `https://github.com/facebook/react-native/releases/tag/v${_semver().default.major(
        v
      )}.${_semver().default.minor(v)}.0`
...
function upgradeProjectFiles(projectDir, projectName) {
  ...
  (0, _copyProjectTemplateAndReplace.default)(
    _path().default.dirname(require.resolve('react-native/template')),
    projectDir,
    projectName,
    {
      upgrade: true
