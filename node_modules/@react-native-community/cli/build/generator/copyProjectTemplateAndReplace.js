...
var _copyAndReplace = _interopRequireDefault(require('../util/copyAndReplace'));

var _promptSync = _interopRequireDefault(require('./promptSync'));

var _walk = _interopRequireDefault(require('../util/walk'));
...
function copyProjectTemplateAndReplace(
  ...
  (0, _walk.default)(srcPath).forEach(absoluteSrcFilePath => {
    ...
    const relativeFilePath = translateFilePath(
      _path().default.relative(srcPath, absoluteSrcFilePath)
    )
      .replace(/HelloWorld/g, newProjectName)
      .replace(/helloworld/g, newProjectName.toLowerCase()); // Templates may contain files that we don't want to copy.
    // Examples:
    ...
    (0, _copyAndReplace.default)(
      absoluteSrcFilePath,
      _path().default.resolve(destPath, relativeFilePath),
      {
...
function upgradeFileContentChangedCallback(
  ...
  if (contentChanged === 'changed') {
    _logger.default.info(
      `${_chalk().default.bold(relativeDestPath)} ` +
